...
public class PatientActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reportsymptom=(AppCompatButton)findViewById(R.id.reportsymptoms);
        reportsymptom.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on click
                Intent intent = new Intent(getApplicationContext(), ReportSymptoms.class);
                startActivity(intent);

            }
        });
    }
    public void startSymptomActivity(View view)
    {
